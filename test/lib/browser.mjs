...
for (const profile of ['minimum', 'current']) {
  ...
  execFileSync(process.execPath, [tsds, 'test:browser', '--config', `wtr.${profile}.config.mjs`, 'test/unit/dom.test.tsx', 'test/exports/import.test.ts', 'test/exports/import.test.mjs', 'test/exports/umd-browser.test.ts'], { stdio: 'inherit' });
}
