(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(
        exports,
        require("react"),
        require("react-dom-event"),
        require("react-ref-boundary"),
      )
    : typeof define === "function" && define.amd
      ? define(
          ["exports", "react", "react-dom-event", "react-ref-boundary"],
          factory,
        )
      : ((global =
          typeof globalThis !== "undefined" ? globalThis : global || self),
        factory(
          (global.reactDomOutside = {}),
          global.React,
          global.reactDomEvent,
          global.ReactRefBoundary,
        ));
})(this, function (exports, react, reactDomEvent, reactRefBoundary) {
  "use strict";

  function Component(param) {
    var children = param.children,
      isActive = param.isActive,
      setIsActive = param.setIsActive;
    var ref = reactRefBoundary.useRef(null);
    var boundary = reactRefBoundary.useBoundary();
    reactDomEvent.useEvent(
      function (event) {
        if (!isActive) return;
  ...
  function ActiveBoundary(param) {
    ...
    return react.createElement(
      reactRefBoundary.BoundaryProvider,
      null,
      react.createElement(
        Component,
        {
